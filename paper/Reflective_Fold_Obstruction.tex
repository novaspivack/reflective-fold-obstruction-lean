...
\url{https://github.com/novaspivack/reflective-fold-obstruction-lean}
(reflective-fold-obstruction development; \texttt{lake build}; see repository \texttt{README} and \texttt{lakefile.lean}.)
