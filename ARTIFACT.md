...
**Semantic type obstruction (`SPEC_020_H3T`, 2026-03-29):** `SemanticType/` — bundled **`Typing`**, **type reachability** / **gaps**, three instances (self-model depth, adjudication kind, RI mor-carrier vs obj), **`semanticType_preorder_nontrivial`**; stable import **`Core/SemanticTypeObstruction`**; flagship paper §9.
